...
groupA = [[30, 10.06, 4.91, 'A_C1_Y_66_20190530', 1500],
              [30, 10.06, 4.91, 'A_C2_Y_66_20190530', 1350],
              [30, 10.06, 4.91, 'A_C3_Y_66_20190530', 1200]]

groupB = [[30, 10.14, 5.12, 'B_C1_Y_67_20190530', 1400],
              [30, 10.14, 5.12, 'B_C2_Y_67_20190530', 1200],
              [30, 10.14, 5.12, 'B_C3_Y_67_20190530', 1000]]

groupC = [[30, 10.17, 4.73, 'C_C1_BK_68_20190530', 1500],
              [30, 10.17, 4.73, 'C_C2_BK_68_20190530', 1350],
              [30, 10.17, 4.73, 'C_C3_BK_68_20190530', 1200]]

groupDY = [[30, 10.13, 5.33, 'D_C1_Y_69_20190530', 1500],
              [30, 10.13, 5.33, 'D_C2_Y_69_20190530', 1350],
              [30, 10.13, 5.33, 'D_C3_Y_69_20190530', 1200]]

groupDBK = [[30, 10.07, 4.76, 'D_C1_BK_70_20190530', 1500],
              [30, 10.07, 4.76, 'D_C2_BK_70_20190530', 1350],
...
def SSCurve(L, W, T, data, file, i, group):
    ...
    # Arrays
    time, force, dis, stress, strain, e = [], [], [], [], [], []
    area = W * T
    ...
    pl.plot(x, y, data = data,
            label = str(stressLevel[i]) + ' N', marker = random.choice(marker),
